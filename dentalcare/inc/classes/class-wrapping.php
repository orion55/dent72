 ...
 */
add_filter('template_include', array('Dentalcare_Wrapping', 'wrap'), 99);
add_filter('dentalcare_wrap_base', 'dentalcare_wrap_base_cpts');
 ...
 */
function dentalcare_template_path()
{
    return Dentalcare_Wrapping::$main_template;
}
 ...
 */
function dentalcare_template_base()
{
    return Dentalcare_Wrapping::$base;
}

if (!class_exists('Dentalcare_Wrapping')) {
    ...
    class Dentalcare_Wrapping
    {
        ...
        /**
         * Initialize new instance of Dentalcare_Wrapping class by setting a variable for the $slug (which defaults to base)
        ...
        {
            $this->templates = apply_filters('dentalcare_wrap_' . $this->slug, $this->templates);
         ...
         * and $base as static variables in Dentalcare_Wrapping class.
         *
         * @since 1.0.0
        ...
        public static function wrap($main)
        {
            ...
            return new Dentalcare_Wrapping();
        }
    }
}
 ...
 */
function dentalcare_wrap_base_cpts($templates)
{
