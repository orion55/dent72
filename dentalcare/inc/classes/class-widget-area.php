...
if ( ! class_exists( 'Dentalcare_Widget_Area' ) ) {

	/**
	 * Class Dentalcare_Widget_Area.
	 */
	class Dentalcare_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'dentalcare_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'dentalcare_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'dentalcare_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function dentalcare_widget_area() {
		return Dentalcare_Widget_Area::get_instance();
	}

	dentalcare_widget_area();
}
