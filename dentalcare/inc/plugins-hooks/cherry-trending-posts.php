...
add_filter( 'cherry_trend_posts_date_args', 'dentalcare_cherry_trend_posts_date_args' );
add_filter( 'cherry_trend_posts_comments_args', 'dentalcare_cherry_trend_posts_comments_args' );
add_filter( 'cherry_trend_posts_author_args', 'dentalcare_cherry_trend_posts_author_args' );
add_filter( 'cherry_trend_posts_category_args', 'dentalcare_cherry_trend_posts_category_args' );
add_filter( 'cherry_trend_posts_tag_args', 'dentalcare_cherry_trend_posts_tag_args' );
add_filter( 'cherry_trend_posts_button_args', 'dentalcare_cherry_trend_posts_button_args' );
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_date_args( $args = array() ) {
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_comments_args( $args = array() ) {
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_author_args( $args = array() ) {
	$args['prefix'] = esc_html__( 'by ', 'dentalcare' );
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_category_args( $args = array() ) {
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_tag_args( $args = array() ) {
 ...
 * @return array
 */
function dentalcare_cherry_trend_posts_button_args( $args = array() ) {
