...
if ( ! class_exists( 'Dentalcare_Elementor' ) ) {

	/**
	 * Define Dentalcare_Elementor class
	 */
	class Dentalcare_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = dentalcare_theme()->get_core()->modules['cherry-js-core'];
			$ui      = dentalcare_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = dentalcare_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'dentalcare-edit', 'dentalcareEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'dentalcare' ) ) {
					continue;
				}
...
/**
 * Returns instance of Dentalcare_Elementor
 *
 * @return object
 */
function dentalcare_elementor() {
	return Dentalcare_Elementor::get_instance();
}

dentalcare_elementor();
