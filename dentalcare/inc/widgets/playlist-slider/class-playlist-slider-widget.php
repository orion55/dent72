...
if ( ! class_exists( 'Dentalcare_Playlist_Slider_Widget' ) ) {

	/**
	 * Class Dentalcare_Playlist_Slider_Widget.
	 */
	class Dentalcare_Playlist_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Playlist Slider', 'dentalcare' );
			$this->widget_description = esc_html__( 'Display playlist slider on your site.', 'dentalcare' );
			$this->widget_id          = apply_filters( 'dentalcare_playlist_slider_widget_ID', 'dentalcare_widget_playlist_slider' );
			$this->widget_cssclass    = apply_filters( 'dentalcare_playlist_slider_widget_cssclass', 'widget-playlist-slider' );
			$this->utility            = dentalcare_utility()->utility;
			$this->settings = array(
				'title' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Playlist Slider', 'dentalcare' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 0,
					'label'     => esc_html__( 'Posts count ( Set 0 to show all. )', 'dentalcare' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width ( px, %, rem )', 'dentalcare' ),
				),
				'height' => array(
					'type' => 'text',
					'value' => '525',
					'label' => esc_html__( 'Slider height ( px, rem )', 'dentalcare' ),
				),
				'thumbnail_controls' => array(
					...
					'value'   => true,
					'options' => array(
						false => esc_html__( 'Hide', 'dentalcare' ),
						true  => esc_html__( 'Buttons', 'dentalcare' ),
					),
					'label'       => esc_html__( 'Select Thumbnail Controls', 'dentalcare' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'dentalcare' ),
				),
				'slider_controls' => array(
					...
					'label'       => esc_html__( 'Select Slider Controls', 'dentalcare' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'dentalcare' ),
				),
				'title_length' => array(
					'type'       => 'stepper',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Title words length ( Set 0 to hide title. )', 'dentalcare' ),
				),
				'thumb_title_length' => array(
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Thumbnail title words length ( Set 0 to hide title. )', 'dentalcare' ),
				),
				'mate_data' => array(
					'type'  => 'checkbox',
					'value' => array(
					...
					'options' => array(
						'date'     => esc_html__( 'Date', 'dentalcare' ),
						'author'   => esc_html__( 'Author', 'dentalcare' ),
						'comments' => esc_html__( 'Comment count', 'dentalcare' ),
						'category' => esc_html__( 'Category', 'dentalcare' ),
						'post_tag' => esc_html__( 'Tag', 'dentalcare' ),
					),
					'label' => esc_html__( 'Display post meta data', 'dentalcare' ),
				),
				'thumb_mate_data' => array(
					...
					'label' => esc_html__( 'Display thumbnail post meta data', 'dentalcare' ),
				),
			);
			...
			$this->layout_settings = apply_filters( 'dentalcare_playlist_slider_size', array(
		...
		public function the_thumbnail_view() {
			$thumbnails_view_dir = dentalcare_get_locate_template( 'inc/widgets/playlist-slider/views/playlist-thumbnails-view.php' );
		...
		public function the_slides_view() {
			$slides_view_dir = dentalcare_get_locate_template( 'inc/widgets/playlist-slider/views/playlist-slides-view.php' );
		...
		public function widget( $args, $instance ) {
			...
			if ( $this->posts ) {
				$slider_settings = array(
					...
					'buttons'            => apply_filters( 'dentalcare_playlist_buttons', false ),
				...
				$holder_view_dir = dentalcare_get_locate_template( 'inc/widgets/playlist-slider/views/playlist-holder-view.php' );
...
add_action( 'widgets_init', 'dentalcare_register_playlist_slider_widget' );
/**
 * Register playlist-slider widget.
 */
function dentalcare_register_playlist_slider_widget() {
	register_widget( 'Dentalcare_Playlist_Slider_Widget' );
}
