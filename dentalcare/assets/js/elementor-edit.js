( function( $, data ) {
	...
	var dentalcareElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, dentalcareElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, dentalcareElementor.initCb );
		},
	...
	dentalcareElementor.init();

}( jQuery, window.dentalcareEditData ) );
